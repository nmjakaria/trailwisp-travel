...
export default async function NewsMarquee() {
    ...
    return (
        <div  className="w-screen relative left-1/2 right-1/2 -mx-[50vw] bg-zinc-900 text-zinc-100 border-y border-zinc-800 py-2.5 flex items-center overflow-hidden text-xs">
